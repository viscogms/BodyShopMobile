    ...
    return (
        <ScrollView style={{ flex:1, backgroundColor:'#f4f7f8', padding:15 }} keyboardShouldPersistTaps="handled">
            <View style={S.tabRow}>
                ...
                <TouchableOpacity style={[S.tabBtn, adminPartTab==='labor' && S.tabBtnActive]} onPress={() => setAdminPartTab('labor')}>
                    <Text style={[S.tabTxt, adminPartTab==='labor' && {color:BRAND}]}>💼 Labor</Text>
                </TouchableOpacity>
            ...
            {adminPartTab === 'labor' && (
                <LaborSection BRAND={BRAND} apiKey={API_KEY} />
            )}
